package com.bacuti.web.rest.errors;
...
public class ExceptionTranslator extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<Object> handleCustomException(BusinessException ex, NativeWebRequest request) {
    ...
    public ResponseEntity<Object> handleCustomException(InvalidTenantException ex, NativeWebRequest request) {
        ProblemDetailWithCause pdCause = wrapAndCustomizeProblem(ex, request);
        return handleExceptionInternal(ex, pdCause, buildHeaders(ex), HttpStatusCode.valueOf(pdCause.getStatus()), request);
    }
    ...
    private HttpStatus toStatus(final Throwable throwable) {
        if (throwable instanceof BusinessException) {
            return HttpStatus.valueOf(((BusinessException) throwable).getStatusCode());
        }

        if (throwable instanceof InvalidTenantException) {
            return HttpStatus.valueOf(((InvalidTenantException) throwable).getStatusCode());
        }
    ...
    private boolean containsPackageName(String message) {
        ...
        return StringUtils.containsAny(message, "org.", "java.", "net.", "jakarta.", "javax.", "com.", "io.", "de.", "com.bacuti");
    }
}
